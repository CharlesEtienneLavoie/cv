...
data <- rbind(
  tibble(
    ...
    role = "Lead Student Ambassador and Co-founder, Student Ambassador Program",
    where = "Montréal, Québec",
    details = c(
      "Lead of approx. 70 Ambassadors (blog, webinar, logo, Instagram, etc.), Editor-in-Chief (blog)"
    ),
  ...
  tibble(
    ...
    role = "Yoga and Meditation Student Committee Lead",
    where = "Montréal, Québec",
    details = c(
      "Led or organized meditation and yoga sessions, secured grants (CAD 2198) for affordable classes"
    ),
